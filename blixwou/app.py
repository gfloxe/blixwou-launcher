...
class MainWindow(QMainWindow):
    ...
    def __init__(self, root, config, network=True):
        ...
        brand_icon = QLabel()
        brand_icon.setPixmap(QIcon(str(resource("assets/blixwou.ico"))).pixmap(26, 26))
        brand_icon.setFixedSize(28, 28)
        nav.addWidget(brand_icon)
        brand = QLabel("BLIXWOU")
        brand.setStyleSheet("font-weight: 750; letter-spacing: 3px; color: #e4caff; margin-right: 32px;")
        nav.addWidget(brand)
        ...
        adventure = QLabel("V O T R E   A V E N T U R E")
        adventure.setStyleSheet("color: #d3adf5; font-size: 12px; font-weight: 700; letter-spacing: 3px;")
        title_col.addWidget(adventure)
        ...
        self.news_card.setMaximumWidth(500)
